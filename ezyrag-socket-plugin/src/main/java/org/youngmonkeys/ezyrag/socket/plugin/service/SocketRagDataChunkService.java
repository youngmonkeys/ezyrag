...
import org.youngmonkeys.ezyrag.socket.plugin.repo.SocketRagDataChunkRepository;

@EzySingleton
public class SocketRagDataChunkService extends RagDataChunkService {

    public SocketRagDataChunkService(
        SocketRagDataChunkRepository dataChunkRepository,
