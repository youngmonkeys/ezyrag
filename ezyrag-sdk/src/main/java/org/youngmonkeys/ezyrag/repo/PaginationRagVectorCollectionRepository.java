...
public class PaginationRagVectorCollectionRepository extends CommonPaginationRepository<
    ...
    @Override
    protected Class<RagVectorCollection> getEntityType() {
        return RagVectorCollection.class;
    }
}
